    ...
    ?>
        ...
        <div class="container" id="product_detail">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
               ...
               <button type="button"  <?php if ($modal == "liked") { ?>
                class="btn btn-success"<?php } else {?> class="btn btn-outline-secondary" <?php } ?> >
<svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
