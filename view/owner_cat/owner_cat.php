...
class owner_cat extends config{
...
?>
 ...
 <?php } else { ?>
	...
	<div class="container">
	 ...
	 public function list_products_categry() {
		$this->headerscript();
	...
	<?php } else { ?>
     ...
     <?php
		...
		$query_ads = mysqli_query($this->mysqlConfig(),"SELECT * FROM pic_addpost WHERE  addpost_status = 1 $query_params  pic_request=".$_REQUEST['type']." order by $order LIMIT 5 OFFSET ".$_REQUEST['offset']."");
		$count_rows = mysqli_num_rows($query_ads);
		...
		<div id="accordion">
          ...
          <div class="card">
           ...
           <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
            ...
            <?php
            $dates = date("Y-m-d");
			$filter_query=mysqli_query($this->mysqlConfig(),"select DISTINCT pic_category from pic_addpost where addpost_status = 1 and (pic_validity > $dates or pic_validity_auto=1) and pic_request=".$_REQUEST['type'].$filter_str."  order by $order");
           ...
           <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordion">
      		<div class="card-body">
            <?php
			$filter_query=mysqli_query($this->mysqlConfig(),"select DISTINCT pic_post_city from pic_addpost where addpost_status = 1 and (pic_validity > $dates or pic_validity_auto=1) and pic_request=".$_REQUEST['type'].$filter_str."  order by $order");
           ...
           <div id="collapseFour" class="collapse show" aria-labelledby="headingFour" data-parent="#accordion">
      		<div class="card-body">
            <?php
			$filter_query=mysqli_query($this->mysqlConfig(),"select DISTINCT pic_add_taluk from pic_addpost where addpost_status = 1 and (pic_validity > $dates or pic_validity_auto=1) and pic_request=".$_REQUEST['type'].$filter_str."  order by $order");
