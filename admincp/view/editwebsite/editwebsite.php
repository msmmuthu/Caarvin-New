<?php
class editwebsite extends config{
...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
          <a class="nav-link" href="index.php?action=view&module=editwebsite&catid=<?php echo $categories_id; ?>&post=edit">General</a>        
      </li>

      <li class="nav-item">
          <a class="nav-link" href="index.php?action=view&module=editwebsite&catid=<?php echo $categories_id; ?>&post=managefield">Fields</a>
      </li>

      <li class="nav-item">
          <a class="nav-link" href="index.php?action=view&module=editwebsite&catid=<?php echo $categories_id; ?>&post=chainfield">Fields Chain</a>
      </li>
    </ul>
...
<?php
   ...
   $categories_id = $_REQUEST['catid'];
	 ...
	 $cat_query = mysqli_query($this->mysqlConfig(),"SELECT * FROM `pic_website` where `id`= $categories_id");
   ...
   <input type="hidden" name="module" value="editwebsite" />
   ...
   <input type="hidden" name="id" value="<?php echo $categories_id; ?>" />
     ...
     <table width="100%" border="0">
       <tr>
         <td colspan="3">
             <div style="border-bottom:1px dotted #666;" align="center"><h3>Website > <span class="label_title"><?php echo $row->website_name; ?></span></h3></div></td>
         </tr>
       <tr>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
       ...
       <tr>
         ...
         <td>&nbsp;</td>
         <td><label>
           <input class="form-control" type="text" name="cat_name" id="cat_name" value="<?php echo $row->website_name; ?>" />
         </label></td>
       </tr>
       ...
       <tr>
         ...
         <td>&nbsp;</td>
         <td><label>
           <input type="text" name="cat_desc" id="cat_desc" class="form-control" value="<?php echo $row->website_url; ?>" required/>           
         </label></td>
       </tr>
       ...
       <tr>
         ...
         <img style="border-radius: 10px;border: 1px solid #EAC000;" height="100" src="media/weblogo/<?php echo $row->logo; ?>"  />
