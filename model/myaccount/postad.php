...
PIC Team";
		...
		$result_counts = $row_counts->pic_scheme_balance_qty-1;
			...
			mysqli_query($this->mysqlConfig(),"UPDATE  `picads`.`pic_scheme_user` SET  `pic_scheme_balance_qty` =  '$result_counts' WHERE  `pic_scheme_user`.`pic_scheme_user_id` =$row_counts->pic_scheme_user_id");
